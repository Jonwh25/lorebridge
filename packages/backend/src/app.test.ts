...
test("journal routes require authentication and return expected status without a connected adapter", async () => {
  await withServer(async (baseUrl) => {
    ...
    const notImplemented = await fetch(`${baseUrl}/v1/journals/j1`);
