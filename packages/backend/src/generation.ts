...
export async function generateSessionPrep(
  ...
  const prompt = [
    ...
    "Wrap any stat block call-outs (DCs, checks, initiative triggers) in: <blockquote class=\"lb-stat-callout\"><p><span class=\"lb-label\">🎲 Mechanics</span><br>{{text}}</p></blockquote>",
    "",
    "## Treasure",
