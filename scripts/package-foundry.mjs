...
await cp(path.join(moduleRoot, "dist"), path.join(stagingRoot, "dist"), { recursive: true });
await cp(path.join(moduleRoot, "styles"), path.join(stagingRoot, "styles"), { recursive: true });
